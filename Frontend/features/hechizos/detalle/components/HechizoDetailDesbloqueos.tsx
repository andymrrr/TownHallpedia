...
interface HechizoDetailDesbloqueosProps {
  data: HechizoDetailData;
}

export const HechizoDetailDesbloqueos: React.FC<HechizoDetailDesbloqueosProps> = ({ data }) => {
      ...
      <View style={[styles.section, { backgroundColor: colors.card }]}>
        <View style={styles.emptyContainer}>
          ...
          <Text style={[styles.emptyText, { color: colors.text + '99' }]}>
            Este hechizo no tiene desbloqueos registrados
          </Text>
        </View>
      </View>
    );
