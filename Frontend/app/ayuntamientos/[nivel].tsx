...
export default function AyuntamientoDetailScreen() {
  ...
  const desbloqueosCount = vm.data.heroes.length + vm.data.tropas.length + vm.data.hechizos.length + vm.data.edificios.length + vm.data.animales.length;
