...
interface EdificioDetailDesbloqueosProps {
  data: EdificioDetailData;
}

export const EdificioDetailDesbloqueos: React.FC<EdificioDetailDesbloqueosProps> = ({ data }) => {
      ...
      <View style={[styles.section, { backgroundColor: colors.card }]}>
        <View style={styles.emptyContainer}>
          ...
          <Text style={[styles.emptyText, { color: colors.text + '99' }]}>
            Este edificio no tiene desbloqueos registrados
          </Text>
        </View>
      </View>
    );
